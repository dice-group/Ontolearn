...
def get_default_arguments(description=None):
    ...
    parser.add_argument("--model", type=str, default="tdl", choices=["celoe", "ocel", "evolearner", "nces", "tdl"],
    ...
    parser.add_argument("--path_learning_problem", type=str, default='../data/LPs/Family/lps.json',
