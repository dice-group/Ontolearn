...
COUNT ( ?s_2 ) <= 4 && COUNT ( ?s_3 ) >= 1
    ...
    def test_Single(self):
        ...
        family_rdf_graph.parse(location="../KGs/Family/family-benchmark_rich_background.owl")
        # knowledge base - using OWLReasoner
        mgr = OWLOntologyManager_Owlready2()
        onto = mgr.load_ontology(IRI.create("../KGs/Family/family-benchmark_rich_background.owl"))
