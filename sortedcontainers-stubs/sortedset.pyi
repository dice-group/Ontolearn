...
class SortedSet(MutableSet[_T], Sequence[_T]):
    ...
    @overload
    def __new__(cls: Type[_SS], iterable: None, key: None) -> _SS: ...
    @overload
    def __new__(
        cls: Type[_SS], iterable: None, key: _Key[_T]
    ) -> _SortedKeySet[_T]: ...
    @overload
    def __new__(cls: Type[_SS], iterable: Iterable[_T], key: None) -> _SS: ...
    @overload
    def __new__(
...
class _SortedKeySet(SortedSet[_T]):
    def __init__(
        self,
        iterable: Optional[Iterable[_T]] = ...,
        key: _Key[_T] = ...,
