...
kb.describe()
lp = LearningProblemGenerator(knowledge_base=kb, num_problems=500,
                              min_length=3, max_length=5, num_of_concurrent_search=3)
export_concepts(kb, lp.concepts) # takes about 70 seconds.
