...
kb = KnowledgeBase(path='../data/KGs/Family/family-benchmark_rich_background.owl')
...
model.fit(lp)
model.save_best_hypothesis(n=3, path='Predictions_Aunt')

model.verbalize("Predictions_Aunt.owl")  # at most n=3 .png files will be generated
