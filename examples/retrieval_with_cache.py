...
parser.add_argument('--cache_size_ratios', type=list, default=[.8], help="cache size is proportional to num_concepts, cache size = k * num_concepts")
...
parser.add_argument('--eviction_strategy', type=str, default='LIFO', choices=['LIFO', 'FIFO', 'LRU', 'MRU', 'RP'])
