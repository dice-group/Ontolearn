...
parser.add_argument('--path_kg', type=list, default=["KGs/Family/father.owl","KGs/Family/family.owl"])
parser.add_argument('--path_kge', type=list, default=None)
parser.add_argument('--name_reasoner', type=str, default='JFact', choices=["EBR",'HermiT', 'Pellet', 'JFact', 'Openllet'])
