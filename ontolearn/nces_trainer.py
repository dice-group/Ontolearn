...
class NCESTrainer:
    ...
    def __init__(self, nces, epochs=300, learning_rate=1e-4, decay_rate=0, clip_value=5.0, num_workers=8, storage_path="./"):
        self.nces = nces
        self.epochs = epochs
    ...
    def collate_batch(self, batch):
        ...
        pos_emb_list[0] = F.pad(pos_emb_list[0], (0, 0, 0, self.nces.num_examples - pos_emb_list[0].shape[0]), "constant", 0)
        pos_emb_list = pad_sequence(pos_emb_list, batch_first=True, padding_value=0)
        neg_emb_list[0] = F.pad(neg_emb_list[0], (0, 0, 0, self.nces.num_examples - neg_emb_list[0].shape[0]), "constant", 0)
    ...
    def train(self, train_dataloader, save_model=True, optimizer='Adam', record_runtime=True):
        ...
        for e in Epochs:
            ...
            for x1, x2, labels in train_dataloader:
                ...
                opt.step()
                if self.decay_rate: self.scheduler.step()
